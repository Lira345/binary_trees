...
/**
 * r_insert_node - The node value insertion in a AVL tree
 * @tree: Pointerof the root node of the AVL trre structure
 * @parent: The parent node
 * @new: Pointer to new node
 * @nval: insertion val of AVL struct
